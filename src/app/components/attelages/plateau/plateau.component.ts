...
export class PlateauComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataService.currentConducteurRating.subscribe(res => {
      ...
      const rate = (this.conducteurRate + this.enginRate + this.equipementRate + this.plateauRate) / 27;
  ...
  onSubmit(form) {
    ...
    this.formValues.vehicule = { matricule: form.controls['matricule'].value, engin: 'Plateau' };
